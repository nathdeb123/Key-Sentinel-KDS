        ...
        try:
            ...
            try:
                ...
                if os.path.exists(icon_path):
                    ...
                    details_window.iconbitmap("KeySentinel_logo.ico")
            except Exception:
                try:
                    details_window.iconbitmap(default="KeySentinel_logo.ico")
                except Exception:
                    pass
...
{'-'*50}"""
        ...
        try:
            ...
            icon_path = os.path.join(os.path.dirname(__file__), "KeySentinel_logo.ico")
            if os.path.exists(icon_path):
                report_window.iconbitmap(icon_path)
            else:
                report_window.iconbitmap("KeySentinel_logo.ico")
        except Exception:
            try:
                report_window.iconbitmap(default="KeySentinel_logo.ico")
            except Exception:
                pass
    ...
    def open_settings(self):
        ...
        try:
            ...
            if os.path.exists(icon_path):
                ...
                settings_window.iconbitmap("KeySentinel_logo.ico")
        except Exception:
            try:
                settings_window.iconbitmap(default="KeySentinel_logo.ico")
            except Exception:
                pass
