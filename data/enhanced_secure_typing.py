...
def _set_window_icon(win):
    ...
    try:
        ...
        try:
            win.iconbitmap(default="KeySentinel_logo.ico")
        except Exception:
            pass
...
class AdvancedSecureTypingApp:
    def __init__(self):
        ...
        try:
            ...
            pass
        self.window.title("🛡️ KeySentinel Secure Typing  ")
    ...
    def setup_ui(self):
        ...
        title = tk.Label(header_frame, text="🛡️ Secure Typing ", 
